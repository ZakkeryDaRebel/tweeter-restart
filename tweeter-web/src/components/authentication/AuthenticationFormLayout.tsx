      ...
      <div className="form-main w-100 m-auto rounded">
        <form>
          ...
          <div className="text-center mb-3">
            <OAuth name="Google" id="googleTooltip" icon="google"></OAuth>
            <OAuth name="Facebook" id="facebookTooltip" icon="facebook"></OAuth>
            <OAuth name="Twitter" id="twitterTooltip" icon="twitter"></OAuth>
            <OAuth name="LinkedIn" id="linkedInTooltip" icon="linkedin"></OAuth>
            <OAuth name="Github" id="githubTooltip" icon="github"></OAuth>
          </div>
